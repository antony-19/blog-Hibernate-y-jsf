...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2017 a las 22:10:49
...
CREATE TABLE `post` (
  ...
  `contenido` varchar(10000) COLLATE utf8_spanish2_ci NOT NULL,
...
(1, 'Frida', 'Post de prueba', 'Este post solo es de prueba para ver la función', '', '2017-01-04');
